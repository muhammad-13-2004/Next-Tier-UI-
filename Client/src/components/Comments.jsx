...
const Comments = () => {
  return (
    <section className="w-full flex flex-col items-center py-20 bg-white">
      ...
      {/* Stats Box */}
      <div className="border rounded-xl flex overflow-hidden mb-16">
        <div className="px-10 py-6 text-center border-r">
      ...
      <div className="flex gap-10">
        ...
        {/* Comment 2 */}
        <div
          className="bg-white border-2 border-black rounded-xl p-6 flex flex-col justify-between"
          style={{ width: '526px', height: '252px' }}
        >
          {/* Stars */}
          <div className="flex gap-1 text-green-500 text-sm">★ ★ ★ ★ ★</div>
